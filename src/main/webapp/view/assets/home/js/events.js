...
function addProductToWishlist(action, product_id) {
    ...
    var productId = product_id;
    $.ajax({
        url: "/ClothesShop/WishlistServlet",
        type: "get",
        data: {
            action: action,
            product_id: productId,
...
function checkDuplicate(input) {
    ...
    $.ajax({
        url: "/ClothesShop/RegisterServlet",
        type: "post",
        data: {
            username: username,
