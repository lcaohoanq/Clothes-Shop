                        ...
                        <div class="col-sm-12 col-md-3 col-lg-3">
                            ...
                            <div class="dashboard_tab_button">
                                <ul role="tablist" class="nav flex-column dashboard-list">
                                    <li style="margin-bottom: 20px"><img
                                            style="border: 5px solid #f98404; height: 255px"
                                            src="${sessionScope.account.avatar}" width="100%"></li>
                                    <li><a href="#account-details" data-toggle="tab"
                                           class="nav-link active">Account details</a></li>
                                    <c:if test="${sessionScope.account != null && sessionScope.account.roleID == 2}">
                                        <li><a href="#orders" data-toggle="tab" class="nav-link">Orders</a>
                                        </li>
                                    </c:if>
                                        ...
                                        <table class="table">
                                            ...
                                            <c:forEach items="${requestScope.LISTORDERS}" var="o">
                                                <tr>
                                                    ...
                                                    <td>${o.orderDate}</td>
                                                    <td><span
                                                            class="success">${o.status == true ? "Đã giao" : "Chưa giao"}</span>
                                                    </td>
                                                    <td>${o.totalPrice}</td>
                                                    <form action="OrderedDetailsServlet"
                                                          method="GET">
                                                        <td>
                                    ...
                                    <div class="login">
                                        <div class="login_form_container">
                                            <div class="account_login_form">
                                                <form id="form-1" action="EditProfileServlet"
                                                      method="get">
                                                    ...
                                                    <input class="input_type " type="text"
                                                           name="role"
                                                           value="${sessionScope.account.roleID == 1? "Admin" : "Customer"}"
                                                           readonly>
                                                    ...
                                                    <input class="input_type " type="text"
                                                           ...
                                                           readonly>
                                                    <input class="input_type " type="hidden"
                                                           name="avatar"
                                                    ...
                                                    <input class="input_type " type="text"
                                                           ...
                                                           readonly>
                                                    <label>Phone</label>
                                                    <input class="input_type input_read" type="text"
                                                           value="${sessionScope.account.phone}"
                                                           name="phone" readonly>
                                                    <div class="save_button primary_btn default_button">
                                                        <button onclick="changeType(this)" id="edit"
                                                                type="button">Edit
                                                        </button>
                                                    </div>
                                                </form>
